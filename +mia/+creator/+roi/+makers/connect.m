	...
	methods
		...
		function b = make(mia_roi_makers_connect_obj, parameters)
			...
			%
                ...
                L_out_file = [mia_roi_makers_connect_obj.mdir.getpathname() filesep 'ROIs' filesep output_itemname filesep output_itemname '_L' '.mat'];
                roi_out_file = [mia_roi_makers_connect_obj.mdir.getpathname() filesep 'ROIs' filesep output_itemname filesep output_itemname '_ROI' '.mat'];
                ...
                try, mkdir([mia_roi_makers_connect_obj.mdir.getpathname() filesep 'ROIs' filesep output_itemname]); end;
                save(roi_out_file,'CC','-mat');
                save(L_out_file,'L','-mat');
                
                h = mia_roi_makers_connect_obj.mdir.gethistory('images',input_itemname);
                h(end+1) = struct('parent',input_itemname,'operation','mia.creator.roi.makers.connect','parameters',parameters,...
                ...
                str2text([mia_roi_makers_connect_obj.mdir.getpathname() filesep 'ROIs' filesep output_itemname filesep 'parent.txt'], input_itemname);
