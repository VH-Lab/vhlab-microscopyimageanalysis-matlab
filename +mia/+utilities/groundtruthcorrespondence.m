function [stats] = groundtruthcorrespondence(mdir, computer_rois, maskregion_rois, groundtruth_rois, varargin)
% GROUNDTRUTHCORRESPONDENCE 
%
% STATS = mia.utilities.groundtruthcorrespondence(MDIR, COMPUTER_ROIS, MASKREGION_ROIS, GROUNDTRUTH_ROIS, ...)
%
% Given an array tomography directory object (MIA.MIADIR object) MDIR and the names of ROIs that were
...
cla_list = mdir.getitems('CLAs');

cla_comp_mask_fname = mdir.getcolocalizationfilename([maskregion_rois '_x_' computer_rois '_CLA']);
...
cla_comp_gt_fname = mdir.getcolocalizationfilename([groundtruth_rois '_x_' computer_rois '_CLA']);
...
hist = mdir.gethistory('ROIs',computer_rois);
...
roi_comp_params_file = mdir.getroiparametersfilename(cla_comp_gt.colocalization_data.parameters.roi_set_2);
roi_gt_params_file = mdir.getroiparametersfilename(cla_comp_gt.colocalization_data.parameters.roi_set_1);
...
nonres_roi_gt_params_file = mdir.getroiparametersfilename(cla_comp_gt.colocalization_data.parameters.roi_set_1(1:end-3));
