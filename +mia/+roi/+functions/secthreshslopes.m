%% Local Background
function [intensity_thresh,max_neg_slope,cutoff,highest_pixel]= secthreshslopes(mdir,filename,varargin)
% [local_bg,highest_pixel] = SECTHRESHSLOPES(MDIR,FILENAME,VARARGIN) 
