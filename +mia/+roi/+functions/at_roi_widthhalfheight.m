%% Local Background
function [local_bg,whh,highest_pixel]= widthhalfheight(atd,filename,varargin)
% [local_bg,highest_pixel] = mia.roi.roi_functions.at_roi_locbacgr(ATD,FILENAME,VARARGIN) 
