...
mdir.deleteitem('ROIs', deleteitemname);
...
labeledroifilename = mdir.getlabeledroifilename(itemname);
disp(labeledroifilename);

%% test getparent function
disp('========= test getparent function ============')
p = mdir.getparent('ROIs', histitemname);
disp(p)
...
roifilename = mdir.getroifilename(itemname);
disp(roifilename)

%% test getroiparametersfilename function
disp('========= test getroiparametersfilename function ============')
roipfilename = mdir.getroiparametersfilename(itemname, true);
disp(roipfilename);