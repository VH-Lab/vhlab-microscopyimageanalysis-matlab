function tri_shift(dirname,graphical)
% mia.test.creator.colocalization.tri_shift - test mia.creator.colocalization.tri_shift
%
% mia.test.creator.colocalization.tri_shift(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.colocalization.tri_shift test data in the specified
...
%
% See also: mia.miadir, mia.creator.colocalization.tri_shift
%
...
test_output_cla = 'ch1_bw_cla_tri_shift';
...
t = mia.creator.colocalization.tri_shift(mdir, test_input_roi, test_output_cla);

parameters = struct('shifts', -2:2, 'threshold', 0.33, 'roi_set_2', 'ch2_bw_roi', 'roi_set_3', 'ch2_bw_roi'); 
