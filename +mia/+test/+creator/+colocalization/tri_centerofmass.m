function tri_centerofmass(dirname,graphical)
% mia.test.creator.colocalization.tri_centerofmass - test mia.creator.colocalization.tri_centerofmass
%
% mia.test.creator.colocalization.tri_centerofmass(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.colocalization.tri_centerofmass test data in the specified
...
%
% See also: mia.miadir, mia.creator.colocalization.tri_centerofmass
%
...
test_output_cla = 'ch1_bw_cla_tri_centerofmass';
...
t = mia.creator.colocalization.tri_centerofmass(mdir, test_input_roi, test_output_cla);

parameters = struct('distance_threshold', 5, 'distance_infinity', 50, 'show_graphical_progress', 1, 'roi_set_2', 'ch2_bw_roi', 'roi_set_3', 'ch2_bw_roi'); 
