function rethreshold(dirname,graphical)
% mia.test.creator.colocalization.rethreshold - test mia.creator.colocalization.rethreshold
%
% mia.test.creator.colocalization.rethreshold(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.colocalization.rethreshold test data in the specified
...
%
% See also: mia.miadir, mia.creator.colocalization.rethreshold
%
...
test_output_cla = 'ch1_bw_cla_rethreshold';
...
t = mia.creator.colocalization.rethreshold(mdir, test_input_cla, test_output_cla);

parameters = struct('threshold',0.33); 
