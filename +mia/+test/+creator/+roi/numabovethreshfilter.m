function numabovethreshfilter(dirname,graphical)
% mia.test.creator.roi.numabovethreshfilter - test mia.creator.roi.numabovethreshfilter
% 
% mia.test.creator.roi.numabovethreshfilter(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.roi.numabovethreshfilter test data in the specified
...
% 
% See also: mia.miadir, mia.creator.roi.numabovethreshfilter
%
...
test_output_roi = 'ch1_bw_roinumabovethreshfilter';
...
t = mia.creator.roi.numabovethreshfilter(mdir, test_input_roi, test_output_roi); 

parameters = struct('num_above',50,'imagename','');
