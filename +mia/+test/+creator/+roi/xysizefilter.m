function xysizefilter(dirname,graphical)
% mia.test.creator.roi.xysizefilter - test mia.creator.roi.xysizefilter
%
% mia.test.creator.roi.xysizefilter(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.roi.xysizefilter test data in the specified
...
%
% See also: mia.miadir, mia.creator.roi.xysizefilter
%
...
test_output_roi = 'ch1_bw_roixysizefilter';
...
t = mia.creator.roi.xysizefilter(mdir, test_input_roi, test_output_roi);

parameters = struct('size_minimum',1,'size_maximum',Inf);
