function combine(dirname,graphical)
% mia.test.creator.roi.combine - test mia.creator.roi.combine
%
% mia.test.creator.roi.combine(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.roi.combine test data in the specified
...
%
% See also: mia.miadir, mia.creator.roi.combine
%
...
test_output_roi = 'ch1_bw_roicombine';
...
t = mia.creator.roi.combine(mdir, test_input_roi, test_output_roi);
...
if graphical,
    p=t.getuserparameters_nonstandard('the default')
end;
