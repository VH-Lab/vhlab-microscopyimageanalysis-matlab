function secondthresh2(dirname,graphical)
% mia.test.creator.roi.secondthresh2 - test mia.creator.roi.secondthresh2
%
% mia.test.creator.roi.secondthresh2(DIRNAME, GRAPHICAL)
%
% Tests mia.creator.roi.secondthresh2 test data in the specified
...
%
% See also: mia.miadir, mia.creator.roi.secondthresh2
%
...
test_output_roi = 'ch1_bw_roisecondthresh2';
...
t = mia.creator.roi.secondthresh2(mdir, test_input_roi, test_output_roi);
