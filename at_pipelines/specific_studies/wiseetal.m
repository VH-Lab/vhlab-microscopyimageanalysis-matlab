...
at_foreachdirdo(d(1:15), ['vh_coloc1(atd,''PSDDECsv2_vf'',''spines_over64'',''PSDDECsv2_ON_SPINE'',''overlap_threshold'',0.33);'])
at_foreachdirdo(d(1:15),['vh_coloc1(atd,''PSDDECsv2_vf'',''VGDECsv1_vf'',''PSDDECsv1_ON_VGDECsv1'');'])
