...
at_foreachdirdo(d_here,'vh_filter2tbrightness(atd,''PSD_DECsv4_roires'',''PSD_DECsv5_roiresbf'');');
at_foreachdirdo(d_here,'vh_filter2tbrightness(atd,''VG_DECsv4_roires'',''VG_DECsv5_roiresbf'');');
