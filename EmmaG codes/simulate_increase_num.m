function [surrogate_CC num_overlaps] = simulate_increase_num(file_folder)
...
for n=1:nSims
    ...
    [surrogate_CC,surrogate_L] = Simulating_psdset_numchange(control_psd_file,ttxtreated_psd_file);
    xrange = (-2:1:2);
    yrange = (-2:1:2);
    zrange = (-2:1:2);
